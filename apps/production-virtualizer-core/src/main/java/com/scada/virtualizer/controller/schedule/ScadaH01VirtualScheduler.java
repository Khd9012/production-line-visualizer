...
public class ScadaH01VirtualScheduler {
    ...
    public void registerTask() {
        schedulerManager.registerTask("H01",this::taskService,1000);
        log.info("H01 작업 매니저에 등록됨");
    }

    public void taskService() {
        scadaBizService.hPlc05Process();
        log.info("H01 가상 작업 실행됨!");
    }
}
